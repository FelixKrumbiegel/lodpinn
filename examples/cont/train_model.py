...
if __name__ == '__main__':
    ...
    N_coarse = np.array([6, 6])  # nbr of elements
    N_fine_per_element = np.array([6, 6])
    ell = 1
    ...
    PDEcoeff = PDEcoeff_class(
        domain, N_coarse*N_fine_per_element+[1], mineps=epsilon_min, maxeps=epsilon_max)
